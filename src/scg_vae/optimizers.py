# from https://github.com/huggingface/pytorch-image-models/blob/main/timm/optim/adamw.py
"""AdamW Optimizer
...
class AdamWLegacy(Optimizer):
    ...
    def __init__(
        ...
        super(AdamWLegacy, self).__init__(params, defaults)  # noqa: UP008

    def __setstate__(self, state):
        super(AdamWLegacy, self).__setstate__(state)  # noqa: UP008
